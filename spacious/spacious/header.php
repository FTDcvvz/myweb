...
<div class="menu-contactme-container">
				<ul>
					<li>
					<a href="https://about.me/ftd-chenwz">关于我</a></li>
					<li>
					<a href="http://www.ftd-chenwz.com/?page_id=97">留言板</a>
					</li>
					<?php wp_register(); ?>
					...
					<?php wp_meta(); ?>
							...
							<?php
								if ( has_nav_menu( 'primary' ) ) {
									wp_nav_menu( array( 'theme_location' => 'primary' ,'container_class' =>'menu-contactme-container' ) );
